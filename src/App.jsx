...
<style>
  ...
  .header .logo { font-family: 'Fredoka One', sans-serif; font-size: 24px; color: #0B8A8A; }
...
function makePdfHeader(facultyName, subtitle) {
  return `<div class="header"><div class="logo">KlasUp</div><div class="faculty">${facultyName || "Faculty"}</div>${subtitle ? `<div class="date">${subtitle}</div>` : ""}</div>`;
}

...
import { generateMicroLearning, generateSemesterReflection, generateAssignmentDoc, updateAssignmentDoc, generatePptPlan, updatePptPlan, generateSyllabus, sendSageChat, embedAllArticles } from "./anthropic";
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 8 }}>
                    <button onClick={async () => {
                      ...
                      try {
                        ...
                        if (!wellnessSession?.access_token) throw new Error('Not signed in');
                        const data = await (await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/generate-micro-learning`, {
                          method: "POST", headers: { "Content-Type": "application/json", "Authorization": `Bearer ${wellnessSession.access_token}` },

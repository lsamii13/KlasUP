...
const features = {
  free: [
    ...
    { label: "Accreditation reports ⸱ Coming Soon", included: false },
  ...
  pro: [
    ...
    { label: "Accreditation reports (NECHE, HLC, SACSCOC, AACSB) ⸱ Coming Soon", included: true },
...
const styles = {
  page: { fontFamily: "'Manrope', sans-serif", maxWidth: 860, margin: "0 auto", padding: "3rem 1.5rem" },
  eyebrow: { fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 13, letterSpacing: "2px", textTransform: "uppercase", color: "#2A9D8F", textAlign: "center", marginBottom: 8 },
  headline: { fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700, fontSize: 42, color: "#1B2B4B", textAlign: "center", margin: "0 0 8px", lineHeight: 1.1 },
  ...
  popularBadge: { position: "absolute", top: -14, left: "50%", transform: "translateX(-50%)", background: "#2A9D8F", color: "white", fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 12, fontWeight: 700, letterSpacing: 1, padding: "4px 18px", borderRadius: 20, whiteSpace: "nowrap" },
  planName: { fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700, fontSize: 24, color: "#1B2B4B", margin: "0 0 4px" },
  planDesc: { fontSize: 13, color: "#5a6a85", margin: "0 0 1.5rem" },
  priceRow: { display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 },
  priceAmount: { fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700, fontSize: 48, color: "#1B2B4B", lineHeight: 1 },
  pricePeriod: { fontSize: 14, color: "#5a6a85" },
  billedNote: { fontSize: 12, color: "#5a6a85", marginBottom: "1.5rem", minHeight: 18 },
  btnFree: { display: "block", width: "100%", padding: "12px", borderRadius: 10, fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700, fontSize: 15, textAlign: "center", cursor: "pointer", background: "transparent", border: "1.5px solid #1B2B4B", color: "#1B2B4B", boxSizing: "border-box" },
  btnPro: { display: "block", width: "100%", padding: "12px", borderRadius: 10, fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700, fontSize: 15, textAlign: "center", cursor: "pointer", background: "#1B2B4B", border: "none", color: "white", boxSizing: "border-box" },
